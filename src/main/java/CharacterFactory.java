...
public class CharacterFactory {
    ...
    public static List<Character> createCharacters() {
        ...
        characters.add(new Character("Character1", 100, new ArrowAttack(), new HandDefend()));
        characters.add(new Character("Character2", 120, new SwordAttack(), new ShieldDefend()));
        ...
        characters.add(new Character("Cyrptarq",95 , new EnergyBlastAtack(), new BlastShieldDefend()));
