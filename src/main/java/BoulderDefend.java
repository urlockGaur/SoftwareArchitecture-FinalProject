...
public class BoulderDefend implements DefendStrategy {
    ...
    public int defend(int currentHealth, int opponentAttack) {
        ...
        if (boulderWall) {
            System.out.println("[VULKANO] Boulder Block is enhanced to Boulder Wall! Nothing is getting through!");
            return (currentHealth + 15);
        } else {
            System.out.println("[VULKANO] Boulder Block defends poorly!");
